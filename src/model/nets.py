...
def build_res_unet(
    ...
    if residual:
        ...
        decoder0_residual_output = tf.keras.layers.Conv2DTranspose(filters=1, kernel_size=int(64), strides=2, padding='same', use_bias=use_bias)(decoder0_residual_output)
